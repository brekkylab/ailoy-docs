...
Once the tools are registered, the agent can invoke them naturally through its
`query()` method:
...
:::note
This example assumes that Node.js and npx are available in your environment.
:::
