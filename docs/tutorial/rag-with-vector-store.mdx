...
In this example, we’ll walk you through a complete RAG workflow — how to build
...
rt = Runtime()
with VectorStore(rt, "bge-m3", "faiss") as vs:
    ...
```
...
with Agent(rt, "qwen3-8b") as agent, VectorStore(rt, "bge-m3", "faiss") as vs:
    # Insert items
    vs.insert(
        "Ailoy is a lightweight library for building AI applications",
        metadata={"topic": "Ailoy"}
